...
if __name__ == '__main__':
    ...
    # 获取数据库监控信息
    print api.get_DescribeDBInstancePerformance('xx','MySQL_QPSTPS,MySQL_COMDML','2018-01-02T15:00Z','2018-01-03T15:00Z')

    # 获取数据库检测报告
    # 通过ram子账号测试
    #print api.get_DiagnosticReport('rr','2018-01-03T10:00Z','2018-01-04T10:00Z')
    # 发通账号测试
    #print api.create_DiagnosticReport('rm', '2018-01-11T10:00Z', '2018-01-11T18:00Z')
    print api.get_DiagnosticReport('rm')
